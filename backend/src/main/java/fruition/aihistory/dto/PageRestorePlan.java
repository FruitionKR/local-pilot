...
public record PageRestorePlan(
    ...
    public static PageRestorePlan delete(String pageId) {
        return new PageRestorePlan(pageId, RestoreAction.delete, null, 0, List.of());
    }

    public static PageRestorePlan restore(String pageId, long targetRevision, int contributionCount) {
        return new PageRestorePlan(pageId, RestoreAction.restore, targetRevision, contributionCount, List.of());
    }

    public static PageRestorePlan rebuild(String pageId, List<Kept> keepContributions) {
        return new PageRestorePlan(pageId, RestoreAction.rebuild, null,
