package fruition.poc.backend.wiki.api;

import fruition.poc.backend.common.ErrorResponse;
import fruition.poc.backend.wiki.dto.WikiGraphResponse;
...
public class WikiController {
    ...
    public ResponseEntity<WikiGraphResponse> getGraph() {
        return ResponseEntity.ok(new WikiGraphResponse(List.of(), List.of()));
    }
    ...
    public ResponseEntity<?> getPage(
            @Parameter(description = "Wiki 페이지 ID", example = "page_concept_456")
