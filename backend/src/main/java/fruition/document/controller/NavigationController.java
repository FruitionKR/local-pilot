...
public class NavigationController {
    ...
    @Operation(summary = "최상위 항목 조회", description = "워크스페이스 최상위의 폴더와 문서를 혼합 정렬 순서로 반환합니다.")
    @ApiResponses({
    ...
    @Operation(summary = "폴더·문서 검색", description = "워크스페이스의 폴더 이름과 문서 파일명을 검색하고 각 결과의 계층 경로를 반환합니다.")
    @ApiResponses({
