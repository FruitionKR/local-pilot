...
| [document-svc](document/README.md) | 80 | 9 | 89 | 문서 저장과 사용자용 AI·Wiki·Agent Gateway |
| [ai-svc](ai/README.md) | 0 | 45 | 45 | 내부 Query·Agent·Wiki·Skill pipeline |

공통 [AI 작업 취소·복구 계약](ai/tasks.md)은 Python과 업무 DB 복구 완료를 함께 확인한다.
