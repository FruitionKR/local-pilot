...
| 서비스 | API 수 | 역할 |
|---|---:|---|
| [access-svc](access/README.md) | 20 | 인증과 워크스페이스 관리 |
| [document-svc](document/README.md) | 83 | 문서 저장과 사용자용 AI·Wiki·Agent API gateway |
| [ai-svc](ai/README.md) | 37 | 내부 Query·Agent·Wiki·Skill pipeline |
