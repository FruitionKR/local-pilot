...
- `issue-2026-07-18.md` — Wiki ingest evaluator 선택적 patch와 fallback 구현 완료 기록. 미해결 평가 작업은 `docs/issue/ai/2026-07-21.md`.
...
- `issue-2026-07-21.md` — 새 노트 생성, pipeline schema 소유권 충돌, Markdown 편집 router·생성 계약 해결 기록. 노트 본문 저장 API 잔여분은 `docs/issue/backend/2026-07-21.md`, pipeline 동시 실행·heartbeat 잔여분은 `docs/issue/ai/2026-07-21.md`.
