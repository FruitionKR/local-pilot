...
- `issue-2026-07-21.md` — 새 노트 생성, pipeline schema 소유권 충돌, Markdown 편집 router·생성 계약, 이메일 인증 회원가입·비밀번호 재설정 API 해결 기록. 노트 본문 저장 API 잔여분은 `docs/issue/backend/2026-07-21.md`, 이메일 인증 프론트 재배선 잔여분은 `docs/issue/frontend/2026-07-21.md`. pipeline 동시 실행·heartbeat는 dev에서 해결(요약은 `docs/changelog/ai.md` 2026-07-21 항목).
