...
- `issue-2026-07-25.md` — Markdown 원문 내보내기 API, wiki-schema Java 프록시, wiki maintenance lint 프록시 완료 기록. 다른 문서 형식 확장은 `docs/issue/backend/2026-07-25.md`, 프론트 연동(schema 목업·maintenance UI)은 별도 Frontend 작업.
