...
- `issue-2026-07-25.md` — Markdown 원문 내보내기 API와 wiki-schema Java 프록시 완료 기록. 다른 문서 형식 확장은 `docs/issue/backend/2026-07-25.md`, wiki-schema 프론트 목업 교체는 별도 Frontend 작업.
