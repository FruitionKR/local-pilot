...
- Backend의 context 저장·전달 후속 작업과 Skill 작성·실행 계약 재정렬을 `docs/backlog/issue/backend/2026-08-09.md`에 기록했다.
...
- Query와 Agent turn에 optional `output_language__, `response_length__, `allow_web_search`를 추가하고 동일한 trusted prompt 규칙을 적용했다.
...
- Spring Flyway가 관리할 checkpoint schema 요구사항을 `docs/backlog/issue/backend/2026-08-06.md`에 기록
...
- Concept 본문 의미 재작성은 안전한 기여 병합 단계가 더 필요해
  `docs/backlog/issue/ai/2026-07-27.md`에서 후속 관리
...
- llmPipeline 운영 접근 제한 후속은 `docs/backlog/issue/infra/2026-07-21.md`로 이관했다.
