...
- **Reply to every review finding in its original thread with the disposition and evidence.** 수정한 지적에는 `수정했습니다.`로 시작해 실제 변경 경계와 검증을 적고, 수정하지 않은 지적에는 `유지했습니다.`로 시작해 계약과 근거를 적는다.
