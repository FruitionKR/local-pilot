...
| `base/postgres.yaml` / `base/redis.yaml` / `base/minio.yaml` | 상태 계층 (single replica + PVC, minio 버킷 init Job 포함) |
...
kubectl apply -f k8s/base/postgres.yaml -f k8s/base/redis.yaml -f k8s/base/minio.yaml
